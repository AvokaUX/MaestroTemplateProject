...
define(["app"], function (app) {
     ...
     * Directive: sticky
     */
    app.ng.directive('sticky', ['$window', '$timeout', 'Resource', 'Form', function ($window, $timeout, Resource, Form) {
            return {
                    ...
                    Form.load().then(function(){
                        if (!Resource.design) {
                            ...
                            function stickElement(closestLine) {
                                // Set sticky state
                                isSticking = true;
                                $elem.attr('style', ''); // clear current styles before setting
                            ...
                            /**
                             * Calculate the sticky bottom line
                             */
                            var calculateStickyBottomLine = function() {
                            ...
                            var onDigest = function() {
                                ...
                                // if($elem.height() != initialCSS.height){
                                //    initialCSS.height = $elem.height();
                                // }
                                calculateStickyBottomLine();
                            ...
                            var onChange = function (newVal, oldVal) {
                                if (( newVal !== oldVal || typeof stickyLine === 'undefined' ) &&
                                    (!isSticking && !isBottomedOut()) && $elem.is(":visible")) {
                            ...
                            function createPlaceholder() {
                                if (usePlaceholder) {
                                    ...
                                    placeholder.css('height', ($elem[0].offsetHeight || 1) + 'px');
                        ...
                        if(Resource.design) {
                            $elem.parent().parent().css("z-index","100");
                        }
                    });
                },
